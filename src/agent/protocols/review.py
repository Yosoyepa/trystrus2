...
GAPS = [
    (
        "Live revocation",
        "AP2 defines how permission is GRANTED, not how it is "
    ...
    (
        "Dispute resolution",
        "AP2 produces signed artefacts but does not say what "
        "answers 'I never authorised this'. Our hash-chained bundle — mandate, "
        "signed intent, approval receipt, capture — is the answer.",
    ),
    (
        "Determinism of the check",
        "Neither AP2 nor ACP forbids a model in the "
...
OTHERS = [
    ...
    (
        "x402 / Coinbase",
        "Machine-native HTTP 402 settlement. Rejected here "
